INSERT INTO public.champion(id, id_name, description, life, attackdamage, attackspeed, speed, regenerationlife, armor, magicresistence, rol, price)
VALUES (1, 'Aatrox', '580 (+80 por nivel)', '60 (+5 por nivel)', 'NaN (+2.5% por nivel)', '8 (+0.75 por nivel)', 345, '33 (+3.25 por nivel)', '32.1 (+1.25 por nivel)', '', 'Asesino','6300'),
       (2, 'Akali','550 (+85 por nivel)', '62.4 (+3.3 por nivel)', 'NaN (+3.2% por nivel)', '6 (+0.5 por nivel)',345, '', '23 (+3.5 por nivel)', '32.1 (+1.25 por nivel)', 'Asesino','3150');
